    ...
    return (
        <>
            <div>
                ...
                <div className=" relative hidden md:block  w-full lg:hidden " style={{ height: " calc(90vw)" }}>
                    <div className="absolute z-20 bottom-4 ">
                        <MovieInfo />
                    </div>
                ...
                <div className="relative hidden w-full lg:block" style={{ height: "30rem" }}>
                    ...
                    <div className="absolute z-30 left-24 w-full top-10 flex items-center gap-10">
